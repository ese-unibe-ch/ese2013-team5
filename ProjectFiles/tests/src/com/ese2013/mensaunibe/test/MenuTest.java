...
public class MenuTest extends TestCase {
	...
	public void testMenusDifferingInTitleShouldBeUnequal() {
		// Note that here the translated titles will not be tested as the
		// translation happens in the api and is not the responsibility of a
		// menu. The German fields are used for comparing and it is assumed
	...
	public void testMenusDifferingInDescriptionShouldBeUnequal() {
		// For the description the same applies as for the titles (see above)
	...
	public void testMenusDifferingInPriceShouldBeUnequal() {
		// For the price the same applies as for the titles (see above)
	...
	public void testMenusDifferingInDateShouldBeUnequal() {
		// For the date the same applies as for the titles (see above)
		Menu other = new Menu(0, 0, "Titel", "Title", "Typ", "Beschreibung",

...
public class CustomListViewPullToRefresh extends ListView {
	...
	public CustomListViewPullToRefresh(Context context) {
		super(context);
		this.context = context;
		init();
	}

	public CustomListViewPullToRefresh(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init();
	}

	public CustomListViewPullToRefresh(Context context, AttributeSet attrs, int defStyle) {
	...
	private void init() {
		...
		headerContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.list_ptr_header, null);

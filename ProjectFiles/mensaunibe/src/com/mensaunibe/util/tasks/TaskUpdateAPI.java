...
public class TaskUpdateAPI extends AsyncTask<Void, Integer, String> {
	...
	public TaskUpdateAPI(ActivityMain controller, String deviceid) {
	...
	public TaskUpdateAPI(ActivityMain controller, String deviceid, String name) {
		this.mController = controller;
		this.mListeners = new ArrayList<TaskListener>();
	...
	public TaskUpdateAPI(ActivityMain controller, String deviceid, int mensaid) {
		this.mController = controller;
		this.mListeners = new ArrayList<TaskListener>();
	...
	public TaskUpdateAPI(ActivityMain controller, String deviceid, int menuid, int rating) {
		this.mController = controller;
		this.mListeners = new ArrayList<TaskListener>();

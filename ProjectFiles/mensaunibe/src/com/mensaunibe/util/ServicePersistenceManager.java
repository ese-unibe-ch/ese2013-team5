...
public class ServicePersistenceManager {
	...
	private static final String TAG = ServicePersistenceManager.class.getSimpleName();
	...
	public ServicePersistenceManager(ActivityMain controller) {
		mController = controller;
		
		// set up the shared prefs, just use the default ones
		mSettings = PreferenceManager.getDefaultSharedPreferences(mController.getContext());
